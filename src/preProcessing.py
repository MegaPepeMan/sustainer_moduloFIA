...
def dataCleaning(dataset, target):
    ...
    colonneNonNumeriche = df.select_dtypes(exclude=['float64', 'int64','float32','int32']).columns.tolist()
    ...
    colonneNumeriche = df.select_dtypes(include=['float64', 'int64', 'float32', 'int32']).columns.tolist()
    colonneNonNumeriche = df.select_dtypes(exclude=['float64', 'int64', 'float32', 'int32']).columns.tolist()
    ...
    print(dfNormalizzato.dtypes)
    X = dfNormalizzato.select_dtypes(include=['float64', 'int64', 'int32', 'float32'])
